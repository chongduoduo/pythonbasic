...
def gold_room():  ##the last room 
    ...
    choice = raw_input(">")
    if "0" in choice or "1" in choice:  ## it means: if there are numbers "0" and "1" in the string, it works. Otherwise it will be dead. for example: 72 is not a right number.
